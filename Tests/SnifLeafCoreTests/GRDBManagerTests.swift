...
final class GRDBManagerTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        testDBURL = dir.appendingPathComponent("test_snifleaf.sqlite3")
        grdbManager = GRDBManager.shared
        grdbManager.openDatabase(databaseURL: testDBURL)
    ...
    func testDatabaseInitialization() async throws {
        XCTAssertTrue(FileManager.default.fileExists(atPath: testDBURL.path), "Database file should exist")
    }
    ...
    private func insertTestLogs() async {
        await grdbManager.insertLogEntry(log: LogEntry(id: nil, timestamp: Date(), method: "GET", url: "https://example.com/api/data", host: "example.com", path: nil, queryParams: nil, requestSize: 200, responseSize: 300, statusCode: 200, latency: 0.15, requestHeaders: nil, responseHeaders: nil, requestBodyContent: nil, responseBodyContent: nil, trafficCategory: .others))
        await grdbManager.insertLogEntry(log: LogEntry(id: nil, timestamp: Date(), method: "POST", url: "https://example.com/api/items", host: "example.com", path: nil, queryParams: nil, requestSize: 250, responseSize: 350, statusCode: 201, latency: 0.20, requestHeaders: nil, responseHeaders: nil, requestBodyContent: nil, responseBodyContent: nil, trafficCategory: .others))
        await grdbManager.insertLogEntry(log: LogEntry(id: nil, timestamp: Date(), method: "PUT", url: "https://anothersite.com/resource", host: "anothersite.com", path: nil, queryParams: nil, requestSize: 180, responseSize: 280, statusCode: 200, latency: 0.10, requestHeaders: nil, responseHeaders: nil, requestBodyContent: nil, responseBodyContent: nil, trafficCategory: .others))
        await grdbManager.insertLogEntry(log: LogEntry(id: nil, timestamp: Date(), method: "GET", url: "https://example.com/error", host: "example.com", path: nil, queryParams: nil, requestSize: 100, responseSize: 150, statusCode: 404, latency: 0.08, requestHeaders: nil, responseHeaders: nil, requestBodyContent: nil, responseBodyContent: nil, trafficCategory: .others))
    }
}
